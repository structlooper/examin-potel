...
<div class="content-wrapper ">
  ...
  <section class="content-header ">
    <div class="container-fluid ">
      <div class="row mb-2 ">
        <div class="col-sm-6 ">
          <a href= "#add_event_form" button type="button " class="popup-with-form btn btn-primary btn-sm ">Add New Event</button></a>
    ...
    <div class="container-fluid ">
      <div class="row ">
        ...
        <div class="col-md-12 ">
          ...
          <table class="table ">
            ...
            <tbody>
              ...
              $res = mysqli_query($conn,"SELECT * FROM tbl_events");
              ...
              while($eventList = mysqli_fetch_assoc($res)){ ?>
                <tr id='tr_<?=$eventList['id'];?>'>
                  ...
                  <td scope="row "><?=$i;?></td>
                  <td scope="row "><?=$eventList['title'];?></td>
                    
                  <td>
                    <img src="../uploads/event-img/<?=$eventList['image'];?>" height="75px" width="100px">
                  </td>              

                  <?php 
                  if($eventList['status']==1){ ?>
                    <td><a href="?type=status&operation=deactive&id=<?=$eventList['id'];?>" class="btn btn-success" data-toggle="tooltip" title="click for deactive">Active</a></td>
                  <?php }else{?>
                    <td><a href="?type=status&operation=active&id=<?=$eventList['id'];?>" class="btn btn-warning" data-toggle="tooltip" title="click for active">Deactive</a></td>
                  <?php }?>

                  <!--   <th scope="row ">Download</th> -->

                  <td>
                    <a href="#update_exam_form" button type="button" class="popup-with-form btn btn-primary btn-sm edit_event" data-event_id="<?php echo $eventList['id'];?>" data-event_name="<?php echo $eventList['exam_name']; ?>">Edit &nbsp;<i class='fa fa-edit'></i></button></a>

                  </a>
                </td>

                <td class="delete"><a href="?did=<?php echo $eventList['id'];?>" data-id="<?php echo $eventList['id'];?>" id="<?php echo $eventList['id'];?>"> <button class="btn btn-danger btn-sm"> Delete &nbsp;<i class='fa fa-trash'></i></button></a></td>
       ...
       <!-- Start Add Event Form 
        ============================================= -->
        <form action="add_update_event.php" method="post" id="add_event_form" class="mfp-hide white-popup-block" enctype="multipart/form-data">
        ...
        <div class="form-group row">
         <label for="colFormLabelSm" class="col-sm-12">Event Name</label>
       </div>
       <div class="form-group row">
        <div class="col-sm-12">
          <input type="text" class="form-control" id="eventName" name="event_name" placeholder="Enter Event Name*" maxlength="100" autocomplete="off" required="">
        </div>
      </div>
      ...
      <div class="form-group row">
        <div class="col-md-12">
          <textarea type="textarea" class="form-control textarea" id="textarea" id="description" name="description" placeholder="description*" rows="5" maxlength="1000" autocomplete="off" ></textarea>
        </div>
      </div>


      <div class="form-group row">
        <label for="colFormLabelSm" class="col-sm-4 col-form-label col-form-label-sm" id="event_time">Event Time*</label>
        <div class="col-sm-8">
          <input type="time" class="form-control" id="event_time" name="event_time" placeholder="Start time">
        </div>
      </div>

      <div class="form-group row">
        <label for="colFormLabelSm" class="col-sm-4">Event Date*</label>
        <div class="col-sm-8">
          <input type="date" class="form-control" id="event_date" name="event_date" placeholder="Start Date">
        </div>
      </div>


      <div class="form-group row">
        <label for="colFormLabelSm" class="col-sm-4">Event Location</label>
        <div class="col-sm-8">
          <input type="text" class="form-control" id="evnt_location" name="evnt_location" placeholder="Event Location" >
        </div>
      </div>
...
<div class="col-md-12">
 <div class="row">
  <button type="submit" class="save" name="add_event">
    Save
  </button>
...
<!-- End Add Class Form -->
            <!-- Start Update Exam Form
              ...
              <form action="add_update_event.php" method="post" id="update_exam_form" class="mfp-hide white-popup-block" enctype="multipart/form-data">
                <div class="col-md-12 login-custom">                                
                  <h4>Update Event</h4>
                  <div class="card-body">                  
                  ...
                  <div class="form-group row">
                    <div class="col-sm-12"><!-- <input type="hidden" id="event_id" name="event_id"> -->
                      <input type="text" class="form-control" id="update_eventName" name="update_eventName" maxlength="100" autocomplete="off">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    <div class="col-md-12">
                      <textarea type="textarea" class="form-control summernote" id="update_description" name="update_description" placeholder="Instruction*" rows="5"></textarea>                   
                    </div>
                  </div>


                  <div class="form-group row">
                    <label for="colFormLabelSm" class="col-sm-4">Event Time*</label>
                    <div class="col-sm-8">
                  ...
                  <div class="form-group row">
                    <label for="colFormLabelSm" class="col-sm-4">Event Location</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="event_location" name="update_event_location" value="" >
                    </div>
                  </div>
    ...
    //alert(event_id);
     ...
     $.ajax({
      ...
      success: function(data){
        ...
        var description = eventData[0].description;

        var image = eventData[0].image;
        var imgUrl = '<?php echo web."uploads/event-img/";?>'+image;

        var event_date = eventData[0].event_date;
        var event_time = eventData[0].event_time;
        var event_location = eventData[0].event_location;
       
        //Now assign the values to the fields of modal
        $('#event_id').val(id);
        $('#update_eventName').val(title);        
        $("#update_description").summernote("code",description);
        $('#update_start_time').val(event_time);
        $('#update_start_date').val(event_date);
