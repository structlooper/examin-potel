                    ...
                    <div class="col-md-4 equal-height">
                        <div class="pricing-item">
                            <ul>
                                ...
                                <li><strong>One Day Trial</strong></li>
                                <li>Limited Courses</li>
                                <li><strong>Free 3 Lessons</strong></li>
                                <li>No Supporter</li>
                                <li>No Ebook</li>
                                <li>No Tutorial</li>
                    ...
                    <div class="col-md-4 equal-height">
                        <div class="pricing-item">
                            <ul>
                                <li class="pricing-header">
                                    <h4>Standard</h4>
                                    <h2><sup>$</sup>39<sub>/ Mo</sub></h2>
                                </li>
                                <li>One Day Standard Access</li>
                                <li>Limited Courses</li>
                                <li><strong>300+ Lessons</strong></li>
                                <li><strong>Random Supporter</strong></li>
                                <li>View Only Ebook</li>
                                <li><strong>Standard Tutorials</strong></li>
                    ...
                    <div class="col-md-4 equal-height">
                        <div class="pricing-item">
                            <ul>
                                ...
                                <li><strong>3000+ Lessons & Growing</strong></li>
