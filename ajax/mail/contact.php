...
$e_body = "You have been contacted by, their additional message is as follows." . PHP_EOL . PHP_EOL;
...
if(mail($address, $e_subject, $msg, $headers)) {
	...
	echo "<p>Thank you <strong>$email</strong>, your message has been submitted to us.</p>";
	echo "</div>";

	$sql = "INSERT INTO user_enquiry(name,email,phone,enquiry) VALUES ('$name','$email','$phone', '$comments')";
